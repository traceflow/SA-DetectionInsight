require([
    ...
    var initialSetupSearch = mvc.Components.get("checkBaseLookupIsPopulated");
    var setupResults = initialSetupSearch.data("results");

    setupResults.on("data", function() {
        if (!setupResults.hasData()) {
